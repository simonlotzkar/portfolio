...
export const myProjects: Project[] = [
    {
        ...
        date: "2024, May",
        description: "Medical assistant AI chatbot and health dashboard. Built in 5 weeks at BCIT using Js, EJS, Tailwind, Node.js, MongoDB, OpenAI, Nodemailer, and Openweather. Clicking the hosted link will take a moment to spin up (load initially).",
    ...
    },
    {
        ...
        subtitle: "School Project",
        date: "2023, Sept-Dec",
        description: "McDonalds icecream machine status tracker. Users can submit reports on McDonalds locations indicating if machines are 'working' or 'not working'. Meant to help consumers avoid broken machines. Built using Javascript, Bootstrap, and Firebase/Firestore",
